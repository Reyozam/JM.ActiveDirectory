...
Function Test-LDAP {
    ...
    foreach ($Computer in $ComputerName) {
        ...
        $GlobalCatalogSSL = TestLDAPPorts -ServerName $ServerName -Port $GCPortLDAPSSL
        $GlobalCatalogNonSSL = TestLDAPPorts -ServerName $ServerName -Port $GCPortLDAP
        $ConnectionLDAPS = TestLDAPPorts -ServerName $ServerName -Port $PortLDAPS
        $ConnectionLDAP = TestLDAPPorts -ServerName $ServerName -Port $PortLDAP
        $PortsThatWork = @(
