...
function Get-JMADLockOutInfo {

    <# 
    .SYNOPSIS 
        Get-JMADLockOutInfo returns a list of users who were locked out in Active Directory. 
      
    .DESCRIPTION 
        Get-JMADLockOutInfo is an advanced function that returns a list of users who were locked out in Active Directory 
    ...
    .EXAMPLE 
        Get-JMADLockOutInfo
    .EXAMPLE
        Get-JMADLockOutInfo -Credential (Get-Credential)
      
    .EXAMPLE 
        Get-JMADLockOutInfo -UserName 'jmazoyer' 
      
    .EXAMPLE 
        Get-JMADLockOutInfo -StartTime (Get-Date).AddDays(-1) 
      
    .EXAMPLE 
        Get-JMADLockOutInfo -UserName 'jmazoyer' -StartTime (Get-Date).AddDays(-1) -Credential (Get-Credential)
    #> 
